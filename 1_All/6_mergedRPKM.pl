...
my $output_g = '';  ## such as "6_mergedRPKM/finalMergedPeaks/IP/forward"
...
my $HELP = '
        ...
        ------------------------------------------------------------------------------------------------------------------------------------------------------     
        Usage:
               perl 6_mergedRPKM.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]      
        For instance:
               nohup time  perl 6_mergedRPKM.pl   -in 5_TPM_RPKM/finalMergedPeaks/IP/forward   -out 6_mergedRPKM/finalMergedPeaks/IP/forward     > 6_mergedRPKM.1.runLog.txt  2>&1    &
...
$output_g = '6_mergedRPKM/finalMergedPeaks/IP/forward';      ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl 6_mergedRPKM.pl  -help' \n";
    exit 0;
}
...
for ( my $i=0; $i<=$#inputFiles_g; $i++ ) {
        ...
        system(" Rscript  6_mergedRPKM.R  $input_g/$temp  $input_g/sorted.$temp");
