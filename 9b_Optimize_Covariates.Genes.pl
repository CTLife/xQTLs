...
###################################################################################################################################################################################################
my $input_g  = '';  ## such as "8b_cis_nominal.optimize.genes"   
my $output_g = '';  ## such as "9b_Optimize_Covariates.Genes"
...
my $HELP = '
        ...
        ------------------------------------------------------------------------------------------------------------------------------------------------------     
        Usage:
               perl 9b_Optimize_Covariates.Genes.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]      
        For instance:
               nohup time  perl 9b_Optimize_Covariates.Genes.pl   -in 8b_cis_nominal.optimize.genes   -out 9b_Optimize_Covariates.Genes     > 9b_Optimize_Covariates.Genes.runLog.txt  2>&1    &
...
$input_g  = '8b_cis_nominal.optimize.genes';    ## This is only an initialization value or suggesting value, not default value.
$output_g = '9b_Optimize_Covariates.Genes';     ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl 9b_Optimize_Covariates.Genes.pl  -help' \n";
    exit 0;
}
...
system("Rscript 9b_Optimize_Covariates.Genes.R");
