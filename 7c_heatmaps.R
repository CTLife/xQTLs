...
#################################################
rawMatrix_1a <- read.table("7a_Peaks_Factors/Correlation/4.pearson.cor.txt",    header=FALSE, sep="\t",  quote = "", comment.char = "") 
rawMatrix_1b <- read.table("7b_Genes_Factors/Correlation/4.pearson.cor.txt",     header=FALSE, sep="\t",  quote = "", comment.char = "") 
...
pdf( file = paste(outPath, "heatmap.pdf", sep="/"),  width=10, height=10  )
