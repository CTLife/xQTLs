...
###################################################################################################################################################################################################
my $input_g  = '';  ## such as "1a_quan.peaks"   
my $output_g = '';  ## such as "2a_log2ratio.peaks"
...
my $HELP = '
        ...
        ------------------------------------------------------------------------------------------------------------------------------------------------------     
        Usage:
               perl 2a_log2ratio.peaks.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]      
        For instance:
               nohup time  perl 2a_log2ratio.peaks.pl   -in 1a_quan.peaks   -out 2a_log2ratio.peaks     > 2a_log2ratio.peaks.runLog.txt  2>&1    &
...
$input_g  = '1a_quan.peaks';          ## This is only an initialization value or suggesting value, not default value.
$output_g = '2a_log2ratio.peaks';     ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl 2a_log2ratio.peaks.pl  -help' \n";
    exit 0;
}
