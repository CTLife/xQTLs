...
my $output_g = '';  ## such as "5_TPM_RPKM/finalMergedPeaks/IP"
...
my $HELP = '
        ...
        ------------------------------------------------------------------------------------------------------------------------------------------------------     
        Usage:
               perl 5_TPM_RPKM.pl    [-version]    [-help]    [-in inputDir]   [-gtf GTFfile]    [-out outDir]      
        For instance:
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl 5_TPM_RPKM.pl  -help' \n";
    exit 0;
}
