...
my $output_g = '';  ## such as "7_mergedTPM/finalMergedPeaks/IP/forward"
...
my $HELP = '
        ...
        ------------------------------------------------------------------------------------------------------------------------------------------------------     
        Usage:
               perl 7_mergedTPM.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]      
        For instance:
...
$output_g = '7_mergedTPM/finalMergedPeaks/IP/forward';      ## This is only an initialization value or suggesting value, not default value.
...
if($boole == 1) {
    ...
    say  "\tPlease see help message by using 'perl 7_mergedTPM.pl  -help' \n";
    exit 0;
}
